...
function buscarIdProfesion() {
    ...
    $.ajax({
        ...
        success: function (json) {
            ...
            $("#id_profesion").val(json.id_profesion);
            $("#nombre_profesion").val(json.nombre_profesion);
            if (json.nuevo === "true") {
                $("#botonAgregar"). prop('disabled', false);
                $("#botonModificar").prop('disabled', true); 
                $("#botonEliminar").prop('disabled', true);
                siguienteCampo("#nombre_profesion", "#botonAgregar", true);
            } else {
                $("#botonAgregar").prop('disabled', true);
                $("#botonModificar").prop('disabled', false);
                $("#botonEliminar").prop('disabled', false);
                siguienteCampo("#nombre_profesion", "#botonModificar", true);
            }
        },
        error: function (e) {
